...
const r54 = (location, callback) => {
  require.ensure([], require => {
    callback(null,
      require('./routes/manage/courseManage/WmcCatalogPage'))
  }, 'WmcCatalogPage')
};

const r55 = (location, callback) => {
  require.ensure([], require => {
    callback(null,
      require('./routes/manage/courseManage/WmcTopicPage'))
  }, 'WmcTopicPage')
};
