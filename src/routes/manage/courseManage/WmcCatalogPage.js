...
const RoutePath = "/Member/CourseManage/WmcCatalogPage";
class WmcCatalogPage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcCatalog.list;
    let pagination = this.props.WmcCatalog.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common, WmcCatalog, LoginUser }) {
  return { common, WmcCatalog, LoginUser };
}
export default connect(mapStateToProps)(WmcCatalogPage)
