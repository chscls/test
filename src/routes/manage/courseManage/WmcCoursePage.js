...
const RoutePath = "/Member/CourseManage/WmcCoursePage";
class WmcCoursePage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcCourse.list;
    let pagination = this.props.WmcCourse.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common, WmcCourse, LoginUser }) {
  return { common, WmcCourse, LoginUser };
}
export default connect(mapStateToProps)(WmcCoursePage)
