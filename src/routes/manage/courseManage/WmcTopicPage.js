...
const RoutePath = "/Member/CourseManage/WmcTopicPage";
class WmcTopicPage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcTopic.list;
    let pagination = this.props.WmcTopic.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common, WmcTopic, LoginUser }) {
  return { common, WmcTopic, LoginUser };
}
export default connect(mapStateToProps)(WmcTopicPage)
