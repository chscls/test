...
const RoutePath = "/Member/UserManage/WmcUserPage";
class WmcUserPage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcUser.list;
    let pagination = this.props.WmcUser.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common, WmcUser, LoginUser }) {
  return { common,WmcUser, LoginUser };
}
export default connect(mapStateToProps)(WmcUserPage)
