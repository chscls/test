...
const NameSpace = "WmcLiveAnnounce";
...
const RoutePath = "/Member/LiveManage/WmcLiveAnnouncePage";
class WmcLiveAnnouncePage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcLiveAnnounce.list;
    let pagination = this.props.WmcLiveAnnounce.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common, WmcLiveAnnounce, LoginUser }) {
  return { common,WmcLiveAnnounce, LoginUser };
}
export default connect(mapStateToProps)(WmcLiveAnnouncePage)
