...
const RoutePath = "/Member/LiveManage/WmcLivePage";
class WmcLivePage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcLive.list;
    let pagination = this.props.WmcLive.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common, WmcLive, LoginUser }) {
  return { common,WmcLive, LoginUser };
}
export default connect(mapStateToProps)(WmcLivePage)
