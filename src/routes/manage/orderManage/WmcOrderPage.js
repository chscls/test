...
const RoutePath = "/Member/OrderManage/WmcOrderPage";
class WmcOrderPage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcOrder.list;
    let pagination = this.props.WmcOrder.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common, WmcOrder, LoginUser }) {
  return { common,WmcOrder, LoginUser };
}
export default connect(mapStateToProps)(WmcOrderPage)
