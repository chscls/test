...
const RoutePath = "/Member/OrgManage/WmcOrgPage";
class WmcOrgPage extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
     let { data } = this.props.WmcOrg.list;
    let pagination = this.props.WmcOrg.pagination;
    const columns = [
      {
        title: 'Id',
        dataIndex: 'id',
...
function mapStateToProps({ common,WmcOrg, LoginUser }) {
  return { common,WmcOrg, LoginUser };
}
export default connect(mapStateToProps)(WmcOrgPage)
