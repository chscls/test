...
const NameSpace = "WmcPosterSpace";
...
const RoutePath = "/Member/SiteManage/WmcPosterSpace";
class WmcPosterSpacePage extends React.Component {
  ...
  add = (e, index) => {
    this.setState({  visible: true, selectObj: index != null ? this.props.WmcPosterSpace.list.data[index] : null, modalTitle: index != null ? "编辑" : "新增" });
  }
  handleEdit = (e) => {
